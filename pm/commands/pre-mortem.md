...
/pre-mortem We're launching a new premium subscription tier next month
```
...
- "Want me to **update the PRD** with risk mitigations? (`/write-prd`)"
- "Should I **create test scenarios** for the riskiest areas? (`/test-scenarios`)"
