---
description: Brainstorm team-level OKRs for Autostay's subscription business — qualitative objectives with measurable key results for retention, partner network, and revenue
argument-hint: "<team, product area, or company objective>"
---

# /plan-okrs -- Autostay Team OKR Planning

Generate well-structured OKRs that connect team work to Autostay's company strategy. Produces 3 OKR sets with qualitative objectives and quantitative key results, informed by subscription business benchmarks.

## Invocation

```
/plan-okrs Growth team Q2 — company goal is 2x MRR
/plan-okrs Partner operations squad aligned to "expand partner network"
/plan-okrs Retention team — reduce churn from 5% to 3%
...
- Which side of the marketplace does this team primarily impact? (subscribers, partners, or both)
...
- Reference Autostay-specific examples as inspiration:
  - Subscriber retention: churn rate, renewal rate, NPS
  - Partner network: new partners, partner satisfaction, utilization
  - Revenue growth: MRR, premium conversion, CAC/LTV ratio
...
- Do KRs avoid gaming? (e.g., "onboard 20 partners" without quality checks incentivizes bad partners)
- Do KRs balance subscriber metrics with partner metrics where relevant?
...
- For Autostay, always consider the dual-sided marketplace: subscriber health metrics should be balanced with partner health metrics
